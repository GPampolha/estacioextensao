...
export default function List (){
    ...
    const _renderCard = (item:PropCard,index:number) =>{        
        const color  = item.flag == 'EXCEDENTE'?themas.Colors.blueLigth:item.flag == 'INSUFICIENTE'?themas.Colors.red:themas.Colors.gray
        return (
            <Swipeable  
                    ...
                    <View style={style.rowCard}>
                        <View style={style.rowCardLeft}>
                            ...
                            <View>
                                ...
                                <Text style={style.descriptionCard}>{item.size}</Text>
                                <Text style={style.descriptionCard}>{item.quantity}</Text>
                            </View>
                        </View>
                        <Flag 
                            caption={item.flag} 
    ...
    return(
        <View style={style.container}>
            ...
            <View style={style.header}>
                <Text style={style.greeting}>Bom dia, <Text style={{fontWeight:'bold'}}>Rebeca</Text></Text>
